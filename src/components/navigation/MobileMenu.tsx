              ...
              <div className="flex flex-col h-full pt-24 px-6 pb-6">
                ...
                <div className="mt-auto pt-6 flex-shrink-0">
                  ...
                  <div className="flex justify-center gap-4">
                    <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="mobile-social-btn" aria-label="GitHub">
                    ...
                    <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="mobile-social-btn" aria-label="LinkedIn">
