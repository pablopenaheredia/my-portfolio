    ...
    <>
      ...
      <nav className="fixed left-0 top-0 h-screen w-20 z-50 hidden md:flex flex-col" aria-label="Main navigation">
        ...
        <div className="pt-6 pb-8 flex-shrink-0">
          <a 
            href="#home" 
            className="block text-color-100 text-lg font-light tracking-wider rotate-180 vertical-rl mx-auto hover:text-color-300 transition-colors"
        ...
        <div className="pb-8 flex flex-col items-center gap-4">
          ...
          <button
            ...
            className="nav-social-icon"
            aria-label={language === 'es' ? 'Copiar email' : 'Copy email'}
            title={language === 'es' ? 'Copiar email' : 'Copy email'}
          >
