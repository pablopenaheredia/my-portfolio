...
const projects = [
  ...
  // Extra project placeholder from CV — replace with real project details
  { id: 'p6', name: 'CI/CD Pipeline', description: 'Automated CI/CD and monitoring for deployments.', image: '/placeholder.svg', technologies: ['GitHub Actions','Docker'] }
]
